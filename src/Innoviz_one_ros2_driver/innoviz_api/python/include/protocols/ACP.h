...
namespace invz
{
	...
	*/
	...
	enum CMData
	{
		...
		OGM_OBJECT_LIST									= MODULE_CM_DATA | 0x3000, // OGM object list TLV over service interface
		OGM_LIDAR_DETECTIONS                            = MODULE_CM_DATA | 0x3002, // OGM lidar detection TLV over service interface
		OGM_GEOMETRIES_LIST                             = MODULE_CM_DATA | 0x3003  // OGM geometries list TLV over service interface
	...
	enum GeneralType
	{
		...
		GENERAL_GET_WATCH_DOG = MODULE_GENERAL_PURPOSE_OPCODE | 0x100
	};
	...
	enum ControlType {
		...
		SET_MIPI_COM_STATE =			MODULE_CONTROL_AND_STATUS | 0x0006,
...
#pragma pack(push, 1)
	...
	struct TlvValue_SetMipiComState {
		uint8_t mode;
		uint8_t reserved[3];
	};
