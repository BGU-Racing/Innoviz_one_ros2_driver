...
std::string GetBufferName(FrameDataAttributes attr)
{
	...
	case GRAB_TYPE_OGM_LIDAR_DETECTIONS: return "GrabType.GRAB_TYPE_OGM_LIDAR_DETECTIONS";
	case GRAB_TYPE_OGM_OBJECT_LIST: return "GrabType.GRAB_TYPE_OGM_OBJECT_LIST";
	case GRAB_TYPE_OGM_GEOMETRIES_LIST: return "GrabType.GRAB_TYPE_OGM_GEOMETRIES_LIST";
	default:
