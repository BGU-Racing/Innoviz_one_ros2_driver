...
#pragma pack(push, 1)
	...
	struct OGMLidarDetectionTLV : BlockTLV
	{
		MetaHeader header;
		OGM_LidarDetectionInterface lidar_detection;
	};

	struct OGMObjectListTLV : BlockTLV
	{
		MetaHeader header;
		OGM_ObjectList object_list;
	};

	struct OGMGeometryListTLV : BlockTLV
	{
		MetaHeader header;
		OGM_GeometryList geometry_list;
	};
